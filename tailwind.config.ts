  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        tarhal: {
          orange: {
            light: "hsl(var(--tarhal-orange-light))",
            DEFAULT: "hsl(var(--tarhal-orange))",
            dark: "hsl(var(--tarhal-orange-dark))",
          },
          blue: {
            light: "hsl(var(--tarhal-blue-light))",
            DEFAULT: "hsl(var(--tarhal-blue))",
