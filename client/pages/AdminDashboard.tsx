...
export default function AdminDashboard() {
  ...
  const sidebarItems: { id: string; label: string; icon: any; color: string }[] = [
    ...
    { id: 'ads', label: getLocalizedText('إدارة الإعلانات', 'Ads Management', 'Gestion Annonces'), icon: Megaphone, color: 'text-amber-500' },
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f97316_0,_#0f172a_45%,_#020617_100%)] flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          {activeTab === 'ads' && (
            <AdminAdsManagement getLocalizedText={getLocalizedText} />
          )}
