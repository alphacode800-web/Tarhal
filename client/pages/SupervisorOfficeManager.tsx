...
const SupervisorOfficeManager: React.FC = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      // تحميل البيانات من السيرفر حتى تظهر التعديلات على كل الأجهزة
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <Label className="text-base font-medium flex items-center">
                      ...
                      {text.mainImage || 'صورة المكتب الرئيسية'} <Badge variant="secondary" className="ml-2">{text.optional || 'اختياري'}</Badge>
                    </Label>
                    <div className="flex gap-4">
                      <Input
                        ...
                        placeholder={text.imageUrl || 'أدخل رابط الصورة أو ارفع من الجهاز'}
                        className="flex-1"
                      />
                    ...
                    {formData.imageUrl && (
                      <div className="mt-2">
                        <img
                          ...
                          alt={text.mainImage || 'صورة المكتب'}
                    ...
                    <div className="mt-6">
                      <Label className="text-base font-medium flex items-center mb-2">
                        {text.additionalImages || 'صور إضافية للمكتب'} <Badge variant="secondary" className="ml-2">{text.optional || 'اختياري'}</Badge>
                      </Label>
