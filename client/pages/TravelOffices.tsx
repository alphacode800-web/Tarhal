...
export default function TravelOffices() {
  ...
  const continents = [
    { value: 'all', label: 'جميع القارات', labelEn: 'All Continents' },
    { value: 'africa', label: 'أفريقيا', labelEn: 'Africa' },
    { value: 'asia', label: 'آسيا', labelEn: 'Asia' },
    { value: 'europe', label: 'أوروبا', labelEn: 'Europe' },
    { value: 'america', label: 'أمريكا', labelEn: 'America' },
  ];
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '300ms' }}>
              أكثر من 50 مكتب سياحي في أجمل دول العالم، نقدم لكم أفضل الخدمات السياحية والتجارب الاستثنائية
            </p>
