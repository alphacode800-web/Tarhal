...
-- جدول تخزين بيانات لوحة التحكم (دول، مكاتب، عروض، إعدادات، صور الهيرو، مشرفون)
-- لحفظ التعديلات والصور أونلاين على قاعدة حقيقية
...
CREATE INDEX IF NOT EXISTS idx_admin_data_updated ON admin_data(updated_at);
